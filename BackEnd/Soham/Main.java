...
import BackEnd.Soham.Event.GetNumberOfEvents.TotalEventsController;
...
import BackEnd.Soham.Trip.TripDuration.TripDurationController;
...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        addContextWithCors(server, "/gettripduration", new TripDurationController(), corsFilter);
        ...
        addContextWithCors(server, "/gettotalevents", new TotalEventsController(), corsFilter);
